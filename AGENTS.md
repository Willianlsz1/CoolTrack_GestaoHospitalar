...
Para o *que é* o projeto (propósito, roadmap, schema), veja os links no fim.
...
## Git
- O agente **prepara** o commit (mensagem em português, descrevendo *o quê* e
  *por quê* — nunca só "fix") mas **só executa quando o Willian mandar**.
